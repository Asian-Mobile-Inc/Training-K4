...
public class IssueThreeActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        if (bundleFromLogin != null) {
            mTvEmail.setText(getString(R.string.email_str_param, bundleFromLogin.getString(Constant.KEY_EMAIL)));
            mTvPassword.setText(getString(R.string.password_str_param, bundleFromLogin.getString(Constant.KEY_PASSWORD)));
            ...
            mTvName.setText(getString(R.string.name_str_param, bundleFromUpdateInfo.getString(Constant.KEY_NAME)));
            mTvIdCard.setText(getString(R.string.id_card_str_param, bundleFromUpdateInfo.getString(Constant.KEY_ID_CARD)));
            mTvDegree.setText(getString(R.string.degree_str_param, bundleFromUpdateInfo.getString(Constant.KEY_DEGREE)));
            mTvInterest.setText(getString(R.string.interest_str_param, bundleFromUpdateInfo.getString(Constant.KEY_INTEREST)));
            mTvMoreInfo.setText((getString(R.string.more_info_str_param, bundleFromUpdateInfo.getString(Constant.KEY_MORE_INFO))));
